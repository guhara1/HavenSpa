...
const pocheon = cityPage({
  ...
  dongs: [["소흘읍", "/gyeonggi-north/pocheon-si/soheul-eup/"], ["포천동", "/gyeonggi-north/pocheon-si/pocheon-dong/"], ["선단동", "/gyeonggi-north/pocheon-si/seondan-dong/"], ["일동면", "/gyeonggi-north/pocheon-si/ildong-myeon/"]],
...
const dongducheon = cityPage({
  ...
  dongs: [["지행동", "/gyeonggi-north/dongducheon-si/jihaeng-dong/"], ["생연동", "/gyeonggi-north/dongducheon-si/saengyeon-dong/"], ["보산동", "/gyeonggi-north/dongducheon-si/bosan-dong/"], ["중앙동", "/gyeonggi-north/dongducheon-si/jungang-dong/"]],
...
const gapyeong = cityPage({
  ...
  dongs: [["가평읍", "/gyeonggi-north/gapyeong-gun/gapyeong-eup/"], ["청평면", "/gyeonggi-north/gapyeong-gun/cheongpyeong-myeon/"], ["설악면", "/gyeonggi-north/gapyeong-gun/seorak-myeon/"], ["조종면", "/gyeonggi-north/gapyeong-gun/jojong-myeon/"]],
...
const yeoncheon = cityPage({
  ...
  dongs: [["전곡읍", "/gyeonggi-north/yeoncheon-gun/jeongok-eup/"], ["연천읍", "/gyeonggi-north/yeoncheon-gun/yeoncheon-eup/"], ["청산면", "/gyeonggi-north/yeoncheon-gun/cheongsan-myeon/"], ["백학면", "/gyeonggi-north/yeoncheon-gun/baekhak-myeon/"]],
